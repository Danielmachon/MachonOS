...
main: kernel.c term.c arch/x86/idt.c arch/x86/gdt.c arch/x86/pic.c linker.ld arch/x86/asm/boot.s arch/x86/asm/cpu.s arch/x86/asm/io.s
	...
	$(CC) -T linker.ld -o MachonOS.bin -ffreestanding -nostdlib boot.o io.o idt.o gdt.o pic.o cpu.o kernel.o term.o x86.o -lgcc
